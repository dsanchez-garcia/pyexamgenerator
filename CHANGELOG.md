...
- **Nuevas pruebas de corrección:** `tests/test_grading_session_and_grades.py` (round-trip de sesión, sugerencias Moodle, patrón de justificación, nota final por fichero/columnas con tope, y columnas personalizadas en `ExamGrader`).
